...
$(document).ready(function () {
    ...
    marker.bindPopup(
        "<h3>DCI Hamburg</h3> <img style='margin:0;opacity:1; width: 100px; height: 90px' src='img/mont.png'> <p style='color:green;'>I am right Here!<span class='error_number' style='color:#526865; font-size: 30px;'>" +
        "   " + "Montasir</span></p>"
    )
    // .openPopup(); مباشر 
